		...
		<div>
			<div className='partnership_current'>
				<div className='partner_curr_header'>
					<p>Current Project: </p>
					<h3>Free Health Check for Widows: A Gift of Compassion</h3>
					<p>
						Commenced execution of the $60,000 planned Registration of 2000 widows under GIFSHIP program of
						NHIA to ensure beneficiaries easy and regular access to health check
					</p>
				</div>

				<div className='partners_title'>
					<h3>People partnering with us on this project</h3>
				</div>
				...
				<div className='partner_btn'>
					<Link to='/contact' className='btn_donate'>
						Write us an email to become a partner
					</Link>
				</div>
			</div>
			{/* partners profile */}
